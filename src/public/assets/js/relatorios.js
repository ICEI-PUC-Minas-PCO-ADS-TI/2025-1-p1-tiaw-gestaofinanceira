...
function carregarDadosDoMes(mes, ano) {
    ...
    ]).then(([receitasGerais, despesasGerais]) => {
...
function carregarGraficoBalanco(receitas, despesas) {
    ...
    dadosGraficoBalanco.innerHTML = `
        <div class="dados-balanco"> 
            <p><strong>Receitas do mês:</strong></p>
            <span>R$ ${totalReceitas.toFixed(2)}</span>
        </div>
        <div class="dados-balanco"> 
            <p><strong>Despesas do mês:</strong></p>
            <span> R$ ${totalDespesas.toFixed(2)}</span>
        </div>
        <div class="dados-balanco"> 
            <p><strong>Balanço do mês:</strong></p>
    ...
    graficoReceitas = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: dadosVazios ? ['#ccc', '#ccc'] : ['#4CAF50', '#2196F3', '#FFC107 ', '#9C27B0']
            }]
        },
        options: {
            responsive: true,
    ...
    graficoDespesas = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data:  dadosVazios ? [1, 1] : valores,
                backgroundColor: dadosVazios ? ['#ccc', '#ccc'] : ['#F44336', '#E91E63', '#9C27B0', '#3F51B5 ', '#03A9F4', '#009688 ', '#4CAF50', '#FF9800', '#795548', '#607D8B']
            }]
        },
        options: {
            responsive: true,
