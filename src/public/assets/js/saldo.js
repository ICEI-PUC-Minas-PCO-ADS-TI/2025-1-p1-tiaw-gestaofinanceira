...
function atualizarDashboard(receitasDoMes, despesasDoMes, receitas, despesas) {
    ...
    <h5 style="margin-top:0;">${formatarMoeda(totalReceitas)}</h5>
    `;

    // Atualizar despesas do mês (mostrar como valor negativo)
    document.getElementById('despesas-mes').innerHTML = `
    <h5 style="margin-top:0;">${formatarMoeda(-totalDespesas)}</h5>
    `
}
